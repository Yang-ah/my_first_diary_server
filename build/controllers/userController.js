...
exports.postLogin = exports.postJoin = exports.getLogin = void 0;
...
var setInitData = function setInitData() {
  ...
  months.map(function (month) {
    var strMonth = new Date(thisYear, month, 1).toLocaleString("en-US", {
      month: "long"
    });
    var thisMonthEnd = new Date(thisYear, month + 1, 0).getDate();
    result[strMonth] = [];
    for (var i = 1; i <= thisMonthEnd; i++) {
  ...
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _req$body2 = req.body, email = _req$body2.email, password = _req$body2.password; // email이 같은 user를 찾음
          _context2.next = 3;
...
var getLogin = /*#__PURE__*/function () {
  ...
  return function getLogin(_x5, _x6) {
